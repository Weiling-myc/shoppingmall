var Vue = (function (exports) {
    ...
    class CustomRefImpl {
        constructor(factory) {
            ...
            const {
                get,
                set
            } = factory(() => track(this, "get" /* GET */, 'value'), () => trigger(this, "set" /* SET */, 'value'));
            this._get = get;
            this._set = set;
        }
    ...
    function defineAsyncComponent(source) {
        ...
        const {
            loader, loadingComponent: loadingComponent, errorComponent: errorComponent, delay = 200, timeout, // undefined = never times out
